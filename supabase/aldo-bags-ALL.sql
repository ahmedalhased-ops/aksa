-- ALDO bags — combined: all 66 products in one script.
-- Run AFTER uploading ALL ALDO files (original filenames, unchanged)
-- from 'ALDO BAG NEW' to the 'products' bucket root.
